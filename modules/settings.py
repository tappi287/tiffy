...
class TiffySettings:
    ...
    def load(cls) -> None:
        ...
        Settings.load(TiffySettings, file)
    ...
    @staticmethod
    def setup_lang():
        setup_translation(language=TiffySettings.language)
        LOGGER.debug('Application language loaded from settings: %s', TiffySettings.language)
